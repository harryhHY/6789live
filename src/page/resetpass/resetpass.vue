    ...
    <div class="set">
        <div class="inset">
          ...
          <div class="login-wrap first_wrap" v-if="active == 0">
              <el-form ref="confirmUser" :model="confirmUser" :rules="confirmRules" status-icon class="second_con">
          ...
          <div class="login-wrap sencond_wrap" v-if="active == 1">
              <el-form ref="register" :model="register" :rules="registerRules" status-icon  class="second_con">
                <div class="region_con">
                  <el-form-item  class="filed" prop="phoneNum" label="">
                    <el-input type="" v-model="register.phoneNum" autocomplete="off"><template slot="prepend">+86</template></el-input>
                  </el-form-item>
              </div>
              <!-- 获取验证码 -->
              <div class="code_con">
          ...
          <div class="login-wrap third_wrap" v-if="active == 2">
              <el-form ref="resetpass" :model="resetpass" :rules="resetpassRules" status-icon  class="second_con">

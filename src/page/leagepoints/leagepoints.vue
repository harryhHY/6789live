...
const leagemenu = () => import("../../components/leage/leagemenu");
const pointlist = () => import("../../components/leage/pointlist");
export default {
    name:"leagepoints",
    components: {
        home_herder,

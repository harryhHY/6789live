        ...
        <div class="detal">
                <div class="list_con">
                    ...
                    <div class="content_con">
                        <p class="content" v-html="detail_list.feedback_body">
                        </p>
                        <el-image
                ...
                <div class="reply_con" v-for="(item,index) in reply_list" :key="index">
                    <p class="reply_title"><i class="el-icon-medal-1"></i><span>{{item.user_name}}</span><span>{{item.addtime_format}}</span></p>
                    <div class="content_con">
                        <div class="content" v-html="item.f_r_body">
                        </div>
                        <el-image
